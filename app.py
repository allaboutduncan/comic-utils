...
def search_gcd_metadata_with_selection():
    ...
    try:
        ...
        # Connect to GCD MySQL database
        try:
            gcd_host = os.environ.get('GCD_MYSQL_HOST', '192.168.68.102')
            gcd_port = int(os.environ.get('GCD_MYSQL_PORT', '3306'))
            gcd_database = os.environ.get('GCD_MYSQL_DATABASE', 'gcd_data')
            gcd_user = os.environ.get('GCD_MYSQL_USER', 'clu')
            gcd_password = os.environ.get('GCD_MYSQL_PASSWORD', 'SfBnl30tKGSszPnMZOuI')
